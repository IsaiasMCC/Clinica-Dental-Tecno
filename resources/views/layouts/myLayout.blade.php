        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li>
                        <a href="#"><i class="fa fa-map"></i> <span class="nav-label">Titulo uno</span><span class="fa arrow"></span></a>
                ...
                <a href="layouts.html"><i class="fa fa-diamond"></i> <span class="nav-label">Layouts</span></a>
                    ...
                    <li>
                        <a href="#"><i class="fa fa-bar-chart-o"></i> <span class="nav-label">Titulo dos</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level collapse">
                    ...
                    <li>
                        <a href="mailbox.html"><i class="fa fa-envelope"></i> <span class="nav-label">Titulo tres </span><span class="label label-warning float-right">16/24</span></a>
                        <ul class="nav nav-second-level collapse">
